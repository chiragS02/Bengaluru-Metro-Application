...
import java.io.*;
	...
	public class Graph_M 
	{
		...
		{
			System.out.println("\t Namma Metro Map ");
			System.out.println("\t------------------");
			System.out.println("----------------------------------------------------\n");
			ArrayList<String> keys = new ArrayList<>(vtces.keySet());
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        g.addVertex("Jayaprakash Nagar");
        g.addVertex("Banashankari");
        g.addVertex("Rashtreeya Vidyalaya Road");
        g.addVertex("Jayanagar");
        g.addVertex("South End Circle");
        g.addVertex("Lalbagh West");
        g.addVertex("National College");
        g.addVertex("KR Market");
        g.addVertex("Chickpete");
        g.addVertex("Kempegowda Majestic");
        g.addVertex("City Railway Station");
        g.addVertex("Magadi Road");
        g.addVertex("Hosahalli");
        g.addVertex("Vijayanagar");
        g.addVertex("Attiguppe");
        g.addVertex("Deepanjali Nagar");
        g.addVertex("Mysore Road");
        g.addVertex("Nayandalli");
        g.addVertex("RR Nagar");
        g.addVertex("JnanaBharati");
        g.addVertex("Pattanagere");
        g.addVertex("Kengeri Bus stop");
        g.addVertex("Kengeri");
        g.addVertex("Mantri Square");
        g.addVertex("Srirampura");
        g.addVertex("Kuvempu Road");
        g.addVertex("Rajajinagar");
        g.addVertex("Mahalakshmi");
        g.addVertex("Sandalsoap Factory");
        g.addVertex("Yeshwanthpur");
        g.addVertex("Gorgontepalya");
        g.addVertex("Peenya");
        g.addVertex("Peenya Industry");
        g.addVertex("Jalahalli");
        g.addVertex("Dasarahalli");
        g.addVertex("Nagasandra");
        g.addVertex("Central College");
        g.addVertex("Vidhan Soudha");
        g.addVertex("Cubbon Park");
        g.addVertex("MG Road");
        g.addVertex("Trinity");
        g.addVertex("Halasur"); 
        g.addVertex("Indiranagar");
        g.addVertex("Swami Vivekananda Road");
        g.addVertex("Baiyyapanahalli");

        g.addEdge("Yelachenahalli", "Jayaprakash Nagar", 2);
        g.addEdge("Jayaprakash Nagar", "Banashankari", 1);
        g.addEdge("Banashankari", "Rashtreeya Vidyalaya Road", 2);
        g.addEdge("Rashtreeya Vidyalaya Road", "Jayanagar", 1);
        g.addEdge("Jayanagar", "South End Circle", 1);
        g.addEdge("South End Circle", "Lalbagh West", 1);
        g.addEdge("Lalbagh West", "National College", 2);
        g.addEdge("National College", "KR Market", 1);
        g.addEdge("KR Market", "Chickpete", 1);
        g.addEdge("Chickpete", "Kempegowda Majestic", 2);
        g.addEdge("Kempegowda Majestic", "City Railway Station", 1);
        g.addEdge("City Railway Station", "Magadi Road", 2);
        g.addEdge("Magadi Road", "Hosahalli", 1);
        g.addEdge("Hosahalli", "Vijayanagar", 2);
        g.addEdge("Vijayanagar", "Attiguppe", 1);
        g.addEdge("Attiguppe", "Deepanjali Nagar", 2);
        g.addEdge("Deepanjali Nagar", "Mysore Road", 1);
        g.addEdge("Mysore Road", "Nayandalli", 1);
        g.addEdge("Nayandalli", "RR Nagar", 2);
        g.addEdge("RR Nagar", "JnanaBharati", 1);
        g.addEdge("JnanaBharati", "Pattanagere", 2);
        g.addEdge("Pattanagere", "Kengeri Bus stop", 2);
        g.addEdge("Kengeri Bus stop", "Kengeri", 1);
        g.addEdge("Kempegowda Majestic", "Mantri Square", 2);
        g.addEdge("Mantri Square", "Srirampura", 2);
        g.addEdge("Srirampura", "Kuvempu Road", 1);
        g.addEdge("Kuvempu Road", "Rajajinagar", 1);
        g.addEdge("Rajajinagar", "Mahalakshmi", 2);
        g.addEdge("Mahalakshmi", "Sandalsoap Factory", 2);
        g.addEdge("Sandalsoap Factory", "Yeshwanthpur", 1);
        g.addEdge("Yeshwanthpur", "Gorgontepalya", 2);
        g.addEdge("Gorgontepalya", "Peenya", 1);
        g.addEdge("Peenya", "Peenya Industry", 2);
        g.addEdge("Peenya Industry", "Jalahalli", 1);
        g.addEdge("Jalahalli", "Dasarahalli", 2);
        g.addEdge("Dasarahalli", "Nagasandra", 2);
        g.addEdge("Kempegowda Majestic", "Central College", 2);
        g.addEdge("Central College", "Vidhan Soudha", 1);
        g.addEdge("Vidhan Soudha", "Cubbon Park", 2);
        g.addEdge("Cubbon Park", "MG Road", 2);
        g.addEdge("MG Road", "Trinity", 2);
        g.addEdge("Trinity", "Halasur", 1);
        g.addEdge("Halasur", "Indiranagar", 2);
        g.addEdge("Indiranagar", "Swami Vivekananda Road", 1);
        g.addEdge("Swami Vivekananda Road", "Baiyyapanahalli", 2);
